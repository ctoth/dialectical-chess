...
def test_search_refuted_high_threat_check_is_marked_as_overreach() -> None:
    board = owned_board_from_fen("r1b1k2r/1ppp1ppp/8/pBQ2N2/4P3/2P5/PP2KPPP/RNq4R b kq - 3 13")
